...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [21] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_prefix_array_repeat1, 2), SHIFT(27),
  ...
  [30] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_prefix_array_repeat1, 2), SHIFT(31),
  [33] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_prefix_array_repeat1, 2),
  [35] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_prefix_array_repeat1, 2), SHIFT_REPEAT(27),
  ...
  [44] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_prefix_array_repeat1, 2), SHIFT_REPEAT(31),
  ...
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_content, 1),
  [82] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_content, 1),
  ...
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 2),
  [98] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_prefix_object_repeat1, 2), SHIFT(16),
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 3),
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 4),
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 2),
  [107] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_prefix_object_repeat1, 2), SHIFT_REPEAT(16),
  ...
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prefix_array, 3),
  [122] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [124] = {.entry = {.count = 1, .reusable = true}}, SHIFT(38),
  [126] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2), SHIFT_REPEAT(10),
  [129] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2),
  [131] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_object_repeat1, 2), SHIFT_REPEAT(38),
  [134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_object_repeat1, 2),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pair, 3, .production_id = 2),
  [138] = {.entry = {.count = 1, .reusable = true}}, SHIFT(28),
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prefix_pair, 1, .production_id = 1),
  [142] = {.entry = {.count = 1, .reusable = true}}, SHIFT(4),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prefix_string, 2),
  [146] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_prefix_object_repeat1, 2),
  [150] = {.entry = {.count = 1, .reusable = true}}, SHIFT(59),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prefix_object, 4),
  [154] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prefix_pair, 3, .production_id = 2),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prefix_array, 2),
